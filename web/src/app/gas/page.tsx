...
export default function GasSensorPage() {
    ...
    const unsubscribe = onValue(sensorsQuery, (snapshot) => {
      ...
      if (data) {
        ...
        if (formattedData.length > 0) {
          ...
          setCurrentGas(latestData.gasPercentage);
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-2 h-2 bg-gray-600/20 rounded-full animate-pulse" />
        <div className="absolute top-1/3 right-1/3 w-3 h-3 bg-slate-600/15 rounded-full animate-pulse delay-300" />
        <div className="absolute top-2/3 left-1/2 w-2 h-2 bg-gray-600/20 rounded-full animate-pulse delay-700" />
      ...
      <main className="relative z-10 container mx-auto px-4 py-8 max-w-6xl">
        ...
        <header className="text-center mb-12">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-gray-700 via-slate-600 to-zinc-600">
              Gas Sensor
            </h1>
          </div>
          <p className="text-gray-600 text-lg">
            Real-time smoke & gas monitoring (MQ-2: LPG/CO/CH4)
          </p>
        </header>

        {/* Current Reading Card */}
        <div className="mb-8">
          <div className="bg-gradient-to-br from-gray-50 to-slate-50 rounded-3xl p-8 border border-gray-200 shadow-lg shadow-gray-100/50">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="text-center md:text-left">
                ...
                {isLoading ? (
                  ...
                  <>
                    <div
                      className={`text-6xl md:text-7xl font-bold bg-gradient-to-r ${getGasGradientColor(
                        currentGas
                      )} bg-clip-text text-transparent`}
                    >
                      {currentGas !== null ? `${currentGas}%` : "—"}
                    </div>
                    <div className="text-gray-700 text-xl mt-2 flex items-center gap-2 justify-center md:justify-start">
                      <span
                ...
                <div className="relative w-32 h-32">
                  ...
                  >
                    ...
                    <circle
                      ...
                      strokeWidth="12"
                      strokeLinecap="round"
                      strokeDasharray={`${(currentGas || 0) * 2.51} 251`}
        ...
        {/* Chart Section */}
        <div className="bg-gradient-to-br from-gray-50 to-slate-50 rounded-3xl p-6 md:p-8 border border-gray-200 shadow-lg shadow-gray-100/50">
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-gray-600/70 text-sm">
          ...
          {isLoading ? (
            <div className="h-80 flex items-center justify-center">
              <div className="flex flex-col items-center gap-4">
                ...
                <span className="text-gray-600">Loading sensor data...</span>
              </div>
            </div>
          ) : sensorData.length === 0 ? (
            <div className="h-80 flex items-center justify-center">
              <div className="text-center text-gray-500">
                ...
                <p className="text-sm mt-2">
                  Waiting for data from the gas sensor...
                </p>
              </div>
            </div>
          ) : (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
            <div className="bg-gradient-to-br from-gray-50 to-slate-50 rounded-2xl p-6 border border-gray-200">
              ...
              <div className="text-3xl font-bold text-gray-800">
                {Math.min(...sensorData.map((d) => d.gasPercentage))}%
              </div>
            </div>
            <div className="bg-gradient-to-br from-gray-50 to-slate-50 rounded-2xl p-6 border border-gray-200">
              <div className="flex items-center gap-3 mb-2">
              ...
              <div className="text-3xl font-bold text-gray-800">
                {(
                  sensorData.reduce((acc, d) => acc + d.gasPercentage, 0) /
                  sensorData.length
                ).toFixed(1)}
                %
              </div>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-slate-50 rounded-2xl p-6 border border-gray-200">
              ...
              <div className="text-3xl font-bold text-gray-800">
                {Math.max(...sensorData.map((d) => d.gasPercentage))}%
              </div>
            </div>
          </div>
        )}
