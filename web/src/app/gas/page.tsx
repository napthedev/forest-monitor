      ...
      <main className="relative z-10 container mx-auto px-4 py-8 max-w-6xl">
        ...
        <header className="text-center mb-12">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-linear-to-r from-gray-700 via-slate-600 to-zinc-600">
              Gas Sensor
            </h1>
          </div>
        ...
        <div className="mb-8">
          <div className="bg-linear-to-br from-gray-50 to-slate-50 rounded-3xl p-8 border border-gray-200 shadow-lg shadow-gray-100/50">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="text-center md:text-left">
                ...
                {isLoading ? (
                  ...
                  <>
                    <div
                      className={`text-6xl md:text-7xl font-bold bg-linear-to-r ${getGasGradientColor(
                        currentGas
        ...
        {/* Chart Section */}
        <div className="bg-linear-to-br from-gray-50 to-slate-50 rounded-3xl p-6 md:p-8 border border-gray-200 shadow-lg shadow-gray-100/50">
