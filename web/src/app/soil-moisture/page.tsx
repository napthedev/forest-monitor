    ...
    const unsubscribe = onValue(sensorsQuery, (snapshot) => {
      ...
      if (data) {
        ...
        if (formattedData.length > 0) {
          ...
          setCurrentMoisture(latestData.moisturePercentage);
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-2 h-2 bg-amber-600/20 rounded-full animate-pulse" />
        <div className="absolute top-1/3 right-1/3 w-3 h-3 bg-yellow-600/15 rounded-full animate-pulse delay-300" />
        <div className="absolute top-2/3 left-1/2 w-2 h-2 bg-amber-600/20 rounded-full animate-pulse delay-700" />
        <div className="absolute bottom-1/4 right-1/4 w-4 h-4 bg-yellow-500/10 rounded-full animate-pulse delay-500" />
      </div>
      ...
      <main className="relative z-10 container mx-auto px-4 py-8 max-w-6xl">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg">
            Real-time soil moisture monitoring for forest environments
          </p>
        </header>
        ...
        <div className="mb-8">
          <div className="bg-linear-to-br from-amber-50 to-yellow-50 rounded-3xl p-8 border border-amber-200 shadow-lg shadow-amber-100/50">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="text-center md:text-left">
                ...
                {isLoading ? (
                  <div className="animate-pulse">
                    <div className="h-16 w-32 bg-amber-200 rounded-lg" />
                  </div>
                ) : (
                  <>
                    <div
                    ...
                    <div className="text-amber-800 text-xl mt-2 flex items-center gap-2 justify-center md:justify-start">
                      <span
              ...
              {/* Moisture Level Visual Indicator */}
                ...
                <div className="relative w-32 h-32">
                  ...
                  >
                    ...
                    <circle
                      ...
                      strokeWidth="12"
                      strokeLinecap="round"
                      strokeDasharray={`${(currentMoisture || 0) * 2.51} 251`}
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <svg
                      className={`w-10 h-10 ${
                        currentMoisture !== null && currentMoisture > 70
                          ? "text-blue-600"
                          : "text-amber-700"
          ...
          {isLoading ? (
            <div className="h-80 flex items-center justify-center">
              <div className="flex flex-col items-center gap-4">
                ...
                <span className="text-amber-700">Loading sensor data...</span>
              </div>
            </div>
          ) : sensorData.length === 0 ? (
            <div className="h-80 flex items-center justify-center">
              ...
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <XAxis
                    ...
                    fontSize={12}
                    tickLine={false}
                    axisLine={{ stroke: "rgba(146, 64, 14, 0.4)" }}
                    tick={{ fill: "#6b7280" }}
                  />
                  <YAxis
                    domain={[0, 100]}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
            <div className="bg-linear-to-br from-amber-50 to-yellow-50 rounded-2xl p-6 border border-amber-200">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-amber-800 text-sm uppercase tracking-wide">
                  Minimum
                </span>
              </div>
            ...
            <div className="bg-linear-to-br from-amber-50 to-yellow-50 rounded-2xl p-6 border border-amber-200">
              ...
              <div className="text-3xl font-bold text-gray-800">
                {(
                  sensorData.reduce((acc, d) => acc + d.moisturePercentage, 0) /
                  sensorData.length
                ).toFixed(1)}
                %
              </div>
            ...
            <div className="bg-linear-to-br from-amber-50 to-yellow-50 rounded-2xl p-6 border border-amber-200">
              ...
              <div className="text-3xl font-bold text-gray-800">
                {Math.max(...sensorData.map((d) => d.moisturePercentage))}%
              </div>
            </div>
          </div>
        )}
